...
public class Element extends Node {
     ...
     * @see #textNodes()
     */
    public String text(final String host , final String...tags) {
	                    ...
	                    for(String tag : tags){
	                    	if(element.tag.getName().toLowerCase().equals(tag)){
	                    		if(tag.equalsIgnoreCase("img")){
	                                ...
	                                if(!imgSrc.toLowerCase().startsWith("http") && host!=null && host.length()>0)
	                                {
	                                	imgSrc = host + (imgSrc.startsWith("/") ? imgSrc : "/"+imgSrc );
	                                	element.attr("src", imgSrc) ;
	                                }
	                                for(Attribute attr : element.attributes){
	                                	if(!attr.getKey().equalsIgnoreCase("src")){
